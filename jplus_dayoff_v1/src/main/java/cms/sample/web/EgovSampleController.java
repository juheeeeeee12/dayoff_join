...
import cms.sample.service.EgovSampleService;
import cms.sample.service.SampleDefaultVO;
import cms.sample.service.SampleVO;
...
public class EgovSampleController {
	...
	public ModelAndView selectSampleList(HttpServletResponse response, HttpServletRequest request) throws Exception {
...
//		List<?> sampleList = sampleService.selectSampleList(searchVO);
		...
		List<ZValue> sampleList = cmnService.retrieveCommonList("sample.selectSampleList", zvl);
		modelAndView.addObject("resultList", sampleList);
		
//		int totCnt = sampleService.selectSampleListTotCnt(searchVO);
		int totCnt = cmnService.retrieveCommonInteger("sample.selectSampleListTotCnt", zvl);
		paginationInfo.setTotalRecordCount(totCnt);
		modelAndView.addObject("paginationInfo", paginationInfo);

		modelAndView.addAllObjects(zvl);
		modelAndView.setViewName("egovframework/example/sample/egovSampleList");
		return modelAndView;
	}
