                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table id="demo-foo-addrow" class="table table-hover contact-list footable-loaded footable user-table">
	                            <colgroup>
				                    <col width="8%">
				                    <col width="*">
				                    <col width="5%">
                                ...
                                <tbody>
				                	...
				                	<c:if test="${empty resultList}">
				                		<tr>
					                        <td class="none" colspan="20">등록된 메뉴가 없습니다.</td>
					                    </tr>
				                	</c:if>
                                </tbody>
                                <tfoot>
...
function fn_detail(isModify, menuSeq){
	...
	sbmit("form", "/cms/system/mngCmsMenuWrite.do");
}
