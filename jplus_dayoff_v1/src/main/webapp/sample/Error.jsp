   ...
   <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                <p class="error-img"><img src="/resources/assets/images/background/error-bg.png" alt="error"></p>
                <h3 class="text-uppercase">원하시는 페이지를 찾을 수 없습니다.</h3>
                <p class="text-muted m-t-30 m-b-30">찾으려는 페이지의 주소가 잘못 입력되었거나,<br>주소의 변경 혹은 삭제로 인해 사용하실 수 없습니다.<br>입력하신 페이지의 주소가 정확한지 다시 한번 확인해 주세요.</p>
                <a href=" " class="btn btn-info btn-rounded waves-effect waves-light m-b-40">메인으로 가기</a> </div>
        </div>
    </section>
    <!-- 회원가입 : end -->
