        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">게시판 관리</h3>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- <h6 class="card-subtitle">.color-table .info-table</h6> -->
                                <div class="table-responsive">
                                    <table class="table color-table info-table board-table">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>게시판 타입</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Prohaska</td>
                                                <td>2023.01.30</td>
                                                <td class="state"><span>미사용</span></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>이미지+텍스트형</td>
                                                ...
                                                <td>Admin</td>
                                                <td>2023.01.30</td>
                                                <td class="state"><span class="use">사용</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div>
                        		<button id="write" class="btn btn-success " onclick="location.href = '/sample/boardWrite.jsp'" type="button">글쓰기</button>
                        	</div>
                    </div>
